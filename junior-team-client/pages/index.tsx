              ...
              <div className="flex flex-col gap-10 items-center justify-center h-full w-full ">
                ...
                <div className="flex flex-col gap-5 items-center justify-center">
                  ...
                  <label className="relative block">
                    ...
                    <input
                      className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:ring-none sm:text-sm"
